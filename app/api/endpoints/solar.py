...
@router.get(
    "/solar/current", response_model=SolarActivity, summary="Obtener la actividad solar actual"
)
...
@router.get(
    "/solar/historical_flares",
    response_model=List[SolarFlareEvent],
    summary="Obtener un historial de llamaradas solares",
)
def get_historical_solar_flares() -> List[SolarFlareEvent]:
    ...
    historical_data = [
        ...
        {"date": "2025-08-25", "time": "22:05:00Z", "flare_class": "C3.4", "region": "3449"},
    ]
